...
var _mmachenry$how_much_snow$Main$tableRow = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1._0;
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(_p2.latitude)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(_p2.longitude)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(_p2.distance)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(_p2.metersofsnow)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_elm_community$elm_time$Time_Iso8601$fromDateTime(_p2.predictedfor)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
			...
			if (_p3.ctor === 'Nothing') {
				...
				if (_p3._0.ctor === 'Err') {
					...
					var lon = _elm_lang$core$Basics$toString(
						A2(_mmachenry$how_much_snow$Main$roundTo, 5, _p4.longitude));
					var lat = _elm_lang$core$Basics$toString(
						A2(_mmachenry$how_much_snow$Main$roundTo, 5, _p4.latitude));
					return {
						ctor: '::',
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'font-size', _1: '1.8vw'},
								_1: {ctor: '[]'}
							}
						}
					}
...
var _mmachenry$how_much_snow$Main$errorMessage = _elm_lang$html$Html$div(
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$style(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'margin', _1: '20vh 10vw 20vh 10vw'},
				_1: {
					ctor: '::',
...
var _mmachenry$how_much_snow$Main$unitWord = function (_p5) {
	var _p6 = _p5;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_p6._1 ? 'more ' : '',
		_elm_lang$core$Native_Utils.eq(_p6._0, 1) ? 'inch' : 'inches');
};
var _mmachenry$how_much_snow$Main$verticalCenter = _elm_lang$html$Html$div(
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$style(
			{
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'line-height', _1: '70vh'},
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
...
var _mmachenry$how_much_snow$Main$pendingMessage = function (message) {
	return _mmachenry$how_much_snow$Main$verticalCenter(
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$span,
...
var _mmachenry$how_much_snow$Main$isCurrentlySnowing = function (data) {
	return A2(
		_elm_lang$core$List$any,
		function (_p7) {
			var _p8 = _p7;
			var _p9 = _p8._2;
			return (_elm_lang$core$Native_Utils.cmp(_p8._0.metersofsnow, 1.0e-2) > 0) && ((_elm_lang$core$Native_Utils.cmp(_p9, 0) > 0) && (_elm_lang$core$Native_Utils.cmp(_p9, 1) < 0));
		},
		data);
};
var _mmachenry$how_much_snow$Main$weightPrediction = function (_p10) {
	var _p11 = _p10;
	return (_p11._0.metersofsnow * _p11._1) * _p11._2;
};
var _mmachenry$how_much_snow$Main$timeLeft = F2(
	function (now, prediction) {
		var threeHours = 3 * 60;
		var timeDelta = A2(_elm_community$elm_time$Time_DateTime$delta, prediction.predictedfor, now);
		return A2(
			...
			A2(
				...
				0,
				_elm_lang$core$Basics$toFloat(timeDelta.minutes) / threeHours));
	});
...
var _mmachenry$how_much_snow$Main$howMuchSnow = F2(
	function (now, data) {
		...
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$List$sum(weightedPredictions) / _elm_lang$core$List$sum(uniqueInfluences),
			_1: _mmachenry$how_much_snow$Main$isCurrentlySnowing(embelishedData)
		};
	});
...
var _mmachenry$how_much_snow$Main$initState = function (flags) {
	return {location: _elm_lang$core$Maybe$Nothing, prediction: _elm_lang$core$Maybe$Nothing, debug: flags.debug, randomAmount: 0};
};
var _mmachenry$how_much_snow$Main$apiInvokeUrl = 'https://oziaoyoi7f.execute-api.us-east-1.amazonaws.com/prod/prediction';
var _mmachenry$how_much_snow$Main$inchesPerMeter = 39.3701;
var _mmachenry$how_much_snow$Main$metersToInchesStr = function (_p15) {
	var _p16 = _p15;
	var _p17 = _p16._1;
	var inches = _p16._0 * _mmachenry$how_much_snow$Main$inchesPerMeter;
	if ((_elm_lang$core$Native_Utils.cmp(inches, 0.2) > 0) && (_elm_lang$core$Native_Utils.cmp(inches, 0.75) < 1)) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'Less than 1 ',
			_mmachenry$how_much_snow$Main$unitWord(
				{ctor: '_Tuple2', _0: 1, _1: _p17}));
	} else {
		var rounded = _elm_lang$core$Basics$round(inches);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				...
				' ',
				_mmachenry$how_much_snow$Main$unitWord(
					{ctor: '_Tuple2', _0: rounded, _1: _p17})));
	}
};
var _mmachenry$how_much_snow$Main$displayPrediction = function (_p18) {
	var _p19 = _p18;
	var outputStr = _mmachenry$how_much_snow$Main$metersToInchesStr(
		{ctor: '_Tuple2', _0: _p19._0, _1: _p19._1});
	var size = 80 / _elm_lang$core$Basics$toFloat(
		_elm_lang$core$String$length(outputStr));
	return _mmachenry$how_much_snow$Main$verticalCenter(
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(outputStr),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _mmachenry$how_much_snow$Main$noLocationError = function (randomAmount) {
	return _mmachenry$how_much_snow$Main$errorMessage(
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					' Your device would not share its location with us. We cannot predict how much snow you will get if we don\'t know where you are. But we can give you a random number as a guess. Here you go: ',
					_mmachenry$how_much_snow$Main$metersToInchesStr(
						{ctor: '_Tuple2', _0: randomAmount, _1: false}))),
			_1: {ctor: '[]'}
		});
};
var _mmachenry$how_much_snow$Main$noConnectionError = function (randomAmount) {
	return _mmachenry$how_much_snow$Main$errorMessage(
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					' We were unable to connect to our snowy database. Maybe it\'s our fault, but please check your network and try again. In lieu of a network connection, here\'s a random number as a guess: ',
					_mmachenry$how_much_snow$Main$metersToInchesStr(
						{ctor: '_Tuple2', _0: randomAmount, _1: false}))),
			_1: {ctor: '[]'}
		});
};
var _mmachenry$how_much_snow$Main$outOfRangeError = function (randomAmount) {
	return _mmachenry$how_much_snow$Main$errorMessage(
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					' Your location is outside the coverage area of the SREF model used by this site. If you would like it to be extended to cover you, please contact the US government. In the mean time, here\'s a random number as a guess: ',
					_mmachenry$how_much_snow$Main$metersToInchesStr(
						{ctor: '_Tuple2', _0: randomAmount, _1: false}))),
			_1: {ctor: '[]'}
		});
};
var _mmachenry$how_much_snow$Main$normalView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			ctor: '::',
			_0: function () {
				var _p20 = model.location;
				if (_p20.ctor === 'Nothing') {
					return _mmachenry$how_much_snow$Main$pendingMessage('Getting your location...');
				} else {
					if (_p20._0.ctor === 'Err') {
						return _mmachenry$how_much_snow$Main$noLocationError(model.randomAmount);
					} else {
						var _p21 = model.prediction;
						if (_p21.ctor === 'Nothing') {
							return _mmachenry$how_much_snow$Main$pendingMessage('Getting prediction...');
						} else {
							if (_p21._0.ctor === 'Err') {
								return _mmachenry$how_much_snow$Main$noConnectionError(model.randomAmount);
							} else {
								var _p23 = _p21._0._0;
								var _p22 = _p23.data;
								if (_p22.ctor === '[]') {
									return _mmachenry$how_much_snow$Main$outOfRangeError(model.randomAmount);
								} else {
									var now = _elm_community$elm_time$Time_DateTime$fromTimestamp(_p20._0._0.timestamp);
									return _mmachenry$how_much_snow$Main$displayPrediction(
										A2(_mmachenry$how_much_snow$Main$howMuchSnow, now, _p23.data));
								}
							}
						}
					}
		...
		if (_p24._0.ctor === 'Err') {
			...
			if (_p25.ctor === 'Nothing') {
				...
				if (_p25._0.ctor === 'Err') {
					...
					var _p27 = _p25._0._0;
					var now = _elm_community$elm_time$Time_DateTime$fromTimestamp(_p28.timestamp);
					var _p26 = A2(_mmachenry$how_much_snow$Main$howMuchSnow, now, _p27.data);
					var metersOfSnow = _p26._0;
					var currentlySnowing = _p26._1;
					return A2(
						_elm_lang$html$Html$div,
						{ctor: '[]'},
						{
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(metersOfSnow),
												A2(
													_elm_lang$core$Basics_ops['++'],
													' meters or ',
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(metersOfSnow * _mmachenry$how_much_snow$Main$inchesPerMeter),
														' inches')))),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Displayed as'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: _elm_lang$html$Html$text(
													_mmachenry$how_much_snow$Main$metersToInchesStr(
														{ctor: '_Tuple2', _0: metersOfSnow, _1: currentlySnowing})),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
																...
																_0: A2(
																	...
																	{ctor: '[]'},
																	{
																		...
																		_1: A2(
																			...
																			A2(_mmachenry$how_much_snow$Main$embelish, now, _p27.data))
																	}),
																_1: {ctor: '[]'}
															}
														}
...
var _mmachenry$how_much_snow$Main$view = function (model) {
	return model.debug ? _mmachenry$how_much_snow$Main$debugView(model) : _mmachenry$how_much_snow$Main$normalView(model);
};
var _mmachenry$how_much_snow$Main$Model = F4(
	function (a, b, c, d) {
		return {location: a, prediction: b, debug: c, randomAmount: d};
	});
var _mmachenry$how_much_snow$Main$Flags = function (a) {
	return {debug: a};
};
var _mmachenry$how_much_snow$Main$PredictionData = function (a) {
	return {data: a};
};
...
var _mmachenry$how_much_snow$Main$decodeSnow = A2(
	_elm_lang$core$Json_Decode$map,
...
var _mmachenry$how_much_snow$Main$UpdateRandom = function (a) {
	return {ctor: 'UpdateRandom', _0: a};
};
var _mmachenry$how_much_snow$Main$init = function (flags) {
	return {
		...
		_1: A2(
			_elm_lang$core$Random$generate,
			_mmachenry$how_much_snow$Main$UpdateRandom,
			...
			case 'UpdateLocation':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							location: _elm_lang$core$Maybe$Just(_p31)
						}),
					_1: function () {
						var _p30 = _p31;
						if (_p30.ctor === 'Ok') {
							return _mmachenry$how_much_snow$Main$getSnow(_p30._0);
						} else {
			...
			case 'UpdateSnow':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							prediction: _elm_lang$core$Maybe$Just(_p29._0)
						}),
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							randomAmount: (1 + Math.pow(2.71, _p29._0)) / _mmachenry$how_much_snow$Main$inchesPerMeter
						}),
